...
public class RC390 extends AppCompatActivity {
    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.rc3,R.drawable.rc32,R.drawable.rc33,R.drawable.rc34};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rc390);
        ...
        web.loadUrl("file:///android_asset/rc390.html");
