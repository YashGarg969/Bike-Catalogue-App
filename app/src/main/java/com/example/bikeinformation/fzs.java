...
public class fzs extends AppCompatActivity {

    WebView webview;
    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.fiv1,R.drawable.fiv2,R.drawable.fiv3,R.drawable.fiv4,R.drawable.fiv5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fzs);
        ...
        web.loadUrl("file:///android_asset/fzsfiv3.html");
