...
public class interceptor extends AppCompatActivity {
    ...
    int imageList[]= {R.drawable.inter1,R.drawable.inter2,R.drawable.inter3,R.drawable.inter4,R.drawable.inter5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.loadUrl("file:///android_asset/interceptor.html");
