...
public class classic350 extends AppCompatActivity {
    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.cl1,R.drawable.cl2,R.drawable.cl3,R.drawable.cl4,R.drawable.cl5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_classic350);
        ...
        web.loadUrl("file:///android_asset/classic350.html");
