...
public class jawa42 extends AppCompatActivity {

    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.jawa1,R.drawable.jawa2,R.drawable.jawa3,R.drawable.jawa4,R.drawable.jawa5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jawa42);
        ...
        web.loadUrl("file:///android_asset/jawa42.html");
