...
public class Panigale_V4 extends AppCompatActivity {

    WebView webview;
    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.panigalev41,R.drawable.panigalev42,R.drawable.panigalev43};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panigale_v4);
        ...
        web.loadUrl("file:///android_asset/panigaleV4.html");
