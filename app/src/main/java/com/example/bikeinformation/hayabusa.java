...
public class hayabusa extends AppCompatActivity {
    WebView webview;


    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.hayabusa1,R.drawable.hayabusa2,R.drawable.hayabusa3,R.drawable.hayabusa4,R.drawable.hayabusa5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hayabusa);
        ...
        web.loadUrl("file:///android_asset/hayabusa.html");
