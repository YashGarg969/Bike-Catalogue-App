...
public class RC200 extends AppCompatActivity {
    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.rc21,R.drawable.rc22,R.drawable.rc23};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rc200);
        ...
        web.loadUrl("file:///android_asset/rc200.html");
