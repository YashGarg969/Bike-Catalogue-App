...
public class fzx extends AppCompatActivity {
    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.fz1,R.drawable.fz2,R.drawable.fz3,R.drawable.fz4,R.drawable.fz5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.loadUrl("file:///android_asset/fzx.html");
