...
public class mt15 extends AppCompatActivity {

    WebView webview;
    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.mt1,R.drawable.mt2,R.drawable.mt3,R.drawable.mt4,R.drawable.mt5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.loadUrl("file:///android_asset/mt.html");
