...
public class Duke125 extends Activity {
    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.ktm125img1,R.drawable.ktm125img2,R.drawable.ktm125img3,R.drawable.ktm125img4,R.drawable.ktm125img5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duke125);
        ...
        web.loadUrl("file:///android_asset/duke125.html");
