...
public class Panigale_V2 extends AppCompatActivity {

    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.panigalev21,R.drawable.panigalev22,R.drawable.panigalev23};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_panigale_v2);
        ...
        web.loadUrl("file:///android_asset/panigaleV2.html");
