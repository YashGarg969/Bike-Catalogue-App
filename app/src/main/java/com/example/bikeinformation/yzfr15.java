...
public class yzfr15 extends AppCompatActivity {

    WebView webview;
    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.yz1,R.drawable.yz2,R.drawable.yz3,R.drawable.yz4,R.drawable.yz5};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mt15);
        ...
        web.loadUrl("file:///android_asset/yzf.html");
