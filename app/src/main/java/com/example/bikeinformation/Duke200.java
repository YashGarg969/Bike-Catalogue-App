...
public class Duke200 extends AppCompatActivity {
    WebView webview;

    ImageButton btPrevious,btNext;
    ImageSwitcher imageSwitcher;
    int imageList[]= {R.drawable.duke22,R.drawable.duke23,R.drawable.duke24,R.drawable.duke25};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_duke200);
        ...
        web.loadUrl("file:///android_asset/duke200.html");
